...
- [GitHub Releases](https://github.com/yobo2u/omsub/releases/tag/v0.5.0)
- [Linux amd64 发布包](https://github.com/yobo2u/omsub/releases/download/v0.5.0/cursor-plugin-0.5.0-linux-amd64.tar.gz)
...
`cursor_0.5.0_linux_amd64.zip` 和 `checksums.txt`。ZIP 根目录只包含
