...
- [Linux amd64 发布包](cursor-plugin/release/cursor-plugin-0.2.0-linux-amd64.tar.gz)
...
```text
691f4497ac9ba1978e087aa289e5411598d51d7a79761a6271a4e260ff545c7a  cursor-plugin-0.2.0-linux-amd64.tar.gz
```

当前版本支持 OpenAI Chat Completions 文本请求、非流式响应、SSE 流式响应，以及插件自有的 Cursor 管理页、模型禁用和本地估算用量。Cursor 未公开稳定的 OAuth 订阅剩余额度接口，因此插件会明确显示额度不可用，不会伪造余额或百分比。暂不支持 tools、图片及 Responses API。
